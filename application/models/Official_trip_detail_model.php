...
class Official_trip_detail_model extends CI_Model
{
    ...
    {
        return $this->db->where('id', $id)->get('official_trip_detail')->result_array();
    }

    public function update($id, $data)
    {
        return $this->db->where('id', $id)->update('official_trip_detail', $data);
    }
    ...
    {
        return $this->db->delete('official_trip_detail', ['id' => $id]);
    }
