                    ...
                    <tbody>
                        ...
                        <?php foreach($submenu as $sm) : ?>
                            <tr>
                                ...
                                <td>
                                    <a class="badge badge-success" style="font-size:14px;" href="<?= site_url('menu/editsubmenu/'.$sm['id']); ?>">Perbarui</a>
                                    <a class="badge badge-danger" style="font-size:14px;" href="#!" onclick="deleteConfirm('<?= site_url('menu/deletesubmenu/'.$sm['id']); ?>')">Hapus</a>
                                </td>
                            </tr>
                        <?php $index++; ?>
                        <?php endforeach; ?>
