                    ...
                    <tbody>
                        ...
                        <?php foreach($menu as $m) : ?>
                            <tr>
                                ...
                                <td><?= $m['menu']; ?></td>
                                <td>
                                    <a class="badge badge-success" style="font-size:14px;" href="<?= site_url('menu/editmenu/'.$m['id']); ?>">Ganti</a>
                                    <a class="badge badge-danger" style="font-size:14px;" href="#!" onclick="deleteConfirm('<?= site_url('menu/deletemenu/'.$m['id']); ?>')">Hapus</a>
                                </td>
                            </tr>
                        <?php $index++; ?>
                        <?php endforeach; ?>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">Data terhapus tidak dapat dipulihkan!</div>
      <div class="modal-footer">
