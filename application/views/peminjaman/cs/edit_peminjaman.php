            ...
            <form id="form" class="form-horizontal">
              ...
              <div class="col col-sm-6 col-md-4 col-lg-4 col-lg-4">
                  <div class="kosong">
                    ...
                    <input type="text" class="form-control" name="nosq" id="nosq" placeholder="nomor SQ" required value="<?= $peminjaman['nosq'] ?>">
                  </div>
              </div>
              <div class="col col-sm-6 col-md-4 col-lg-4 col-lg-4">
                  <div class="kosong">
                    <label for='nopo'>Nomor PO</label>
                    <input type="text" class="form-control" name="nopo" id="nopo" placeholder="nomor PO" required readonly value="<?= $peminjaman['nopo'] ?>">
                  </div>
              </div>
            </div>
